...
public class AttacksList : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        listaAtaques.Add(new Attacks(50, "Batida energizada", "Ataque médio que causa mais dano em alvos de metal", Attacks.Tipo.golpe, Attacks.Tipo.zero, 4, 3, true, true, 1, 3, true, false));
        ...
        listaAtaques.Add(new Attacks(64, "Guia", "Pequenos ajudantes usam um segundo ataque menor após você usar qualquer ataque de dano, baseado em dano a distância", Attacks.Tipo.passiva, Attacks.Tipo.golpe, 0, 0, false, true, 0, 0, true, true));
        ...
        listaAtaques.Add(new Attacks(69, "Refletir", "Ataque que causa o mesmo tanto de dano do último ataque inimigo uma vez, Falha se não foi um ataque de dano", Attacks.Tipo.golpe, Attacks.Tipo.zero, 3, 1, false, true, 1, 4, true, false));
