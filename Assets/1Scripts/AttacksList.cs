...
public class AttacksList : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        listaAtaques.Add(new Attacks(48, "Armadura de espinhos", "Enquanto tiver escudo causa um pequeno dano de volta a ser atacado", Attacks.Tipo.passiva, Attacks.Tipo.golpe, 0, 0, true, true, 0, 0, true, true));
